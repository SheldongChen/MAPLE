...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        train_one_epoch(model, criterion, optimizer, lr_scheduler, data_loader, data_loader_unlabel, device, epoch, args.print_freq, xi=args.vat_xi, eps=args.vat_eps, ip=args.vat_ip, alpha=args.vat_alpha, only_ul=args.vat_only_ul, EntMin=args.vat_EntMin)
...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='output/ntu120_twotrans', type=str, help='path where to save')
    # resume
    ...
    parser.add_argument('--vat-eps', default=0.25, type=float, metavar='EPS', help='hyperparameter of VAT')
