...
parser.add_argument('--output_dir', default='point', help='Output processed data directory [default: processed_data]')
...
def process_one_file(filename):
    ...
    np.savez_compressed(os.path.join(output_dir, os.path.basename(filename).split('.')[0] + '.npz'), point_clouds=np.array(point_clouds,dtype=object))
