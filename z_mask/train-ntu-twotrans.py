...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='output/ntu_twotrans_mae', type=str, help='path where to save')
    # resume
    ...
    parser.add_argument('--mask-length', default=6, type=int, help='mask length')
