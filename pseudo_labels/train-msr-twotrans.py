...
def parse_args():
    ...
    parser.add_argument('-bu', '--batch-size-unlabel', default=28, type=int)
    ...
    parser.add_argument('--lr-milestones', nargs='+', default=[70, 80], type=int, help='decrease lr on milestones')
    parser.add_argument('--lr-gamma', default=0.1, type=float, help='decrease lr by a factor of lr-gamma')
    parser.add_argument('--lr-warmup-epochs', default=0, type=int, help='number of warmup epochs')
    parser.add_argument('--loss-annealing', nargs='+', default=[0, 50], type=int, help='epoch of annealing')
    parser.add_argument('--loss-alpha', default=2, type=int, help='alpha for unlabel data loss')
    # output
    parser.add_argument('--print-freq', default=10, type=int, help='print frequency')
    parser.add_argument('--output-dir', default='output/msr_action_pseudo', type=str, help='path where to save')
    # resume
