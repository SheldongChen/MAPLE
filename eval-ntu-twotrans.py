...
def parse_args():
    ...
    parser.add_argument('--data-meta', default='./datasets/ntu/ntu60_half.list', help='dataset')
    ...
    parser.add_argument('--lr-milestones', nargs='+', default=[6, 10], type=int, help='decrease lr on milestones')
    ...
    # resume
    parser.add_argument('--resume', default='./output/ntu_twotrans/model_best.pth', help='resume from checkpoint')
